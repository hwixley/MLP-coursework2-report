...
The principal idea behind residual connections is that is easier for deep neural networks to optimize residual mappings of the input rather than the original, unreferenced mapping of the input. These residual mappings can then be used to calculate the desired underlying mapping of the input:\\
